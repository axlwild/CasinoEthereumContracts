...
contract Tragamonedas3 is usingProvable {
    ...
    function jugar () public payable returns ( uint[] memory ) {
        ...
        jugando = true;
        jugador = msg.sender;
        emit logInfoJuego("El juego comenzó. Espere al menos 1 minuto para consultar su resultado.");
        return casillasObtenidas;
    }
